            ...
            <Row>
              <Col lg={12}>
                <div className="title-box text-center">
                  <h3 className="title-heading mt-4">¡Contáctanos para mas información!</h3>
                  <p className="text-muted f-17 mt-3">Si quieres saber mas sobre el producto o quieres agendar un demo <br /> Dejanos un mensaje y nos comunicaremos contigo.</p>
                  ...
                  <Form method="post" name="contact-form" id="contact-form">
                    ...
                    <Row>
                      <Col lg={12} className="mt-3 text-right">
                        <Input id="submit" name="send" color="primary" className="submitBnt btn btn-primary btn-round" value="Enviar" type="submit" style={{width: 'auto',color: '#fff'}} />{' '}
